...
public class Objectives : MonoBehaviour {
	...
	void Update () {
		...
		} else if (obj5 == true && obj6 == false && someGlobals.gotkey == true) {
			obj6 = true;
			GameObject.Find ("TextBoxManager").GetComponent<TextBoxManager> ().currentLine = 6;
		} else if (obj6 == true && obj7 == false && GameObject.Find ("BeermanRunTrigger").GetComponent<Trigger> ().textline == true) {
			GameObject.Find ("TextBoxManager").GetComponent<TextBoxManager> ().currentLine = 7;
			deltatime += Time.deltaTime;
                if (deltatime > 5f) { obj7 = true; }
        } else if (obj8 == false && deltatime > 5f) {
			obj8 = true;
			GameObject.Find ("TextBoxManager").GetComponent<TextBoxManager> ().currentLine = 8;
		} else if (obj8 == true && obj9 == false && someGlobals.gotkey2 == true) {
			obj7 = true;
			GameObject.Find ("TextBoxManager").GetComponent<TextBoxManager> ().currentLine = 9;
		} else if (obj9 == true && obj10 == false && GameObject.Find ("BeermanRunTrigger").GetComponent<Trigger> ().startTime == true) {
			obj7 = true;
